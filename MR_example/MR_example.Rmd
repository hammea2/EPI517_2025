...
# Inspect the MR data
- What types of information is contained in this dataset?
...
```{r MR results scatterplot}
TwoSampleMR::mr_scatter_plot(basic_MR_results,MR_data)
```

# MR-Egger test for pleiotropy (MR-Egger intercept)
...
# Testing the association with other MR methods
